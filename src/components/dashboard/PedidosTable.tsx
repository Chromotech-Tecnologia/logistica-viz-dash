        ...
        <table className="w-full text-xs">
          ...
          <tbody>
            {paginatedData.map((pedido, index) => (
              ...
              >
                <td className="py-2 px-2 text-primary font-medium whitespace-nowrap">{pedido.nMov}</td>
                <td className="py-2 px-2 text-card-foreground whitespace-nowrap">{pedido.pedido}</td>
                <td className="py-2 px-2 text-card-foreground whitespace-nowrap">{pedido.tipoServico}</td>
                <td className="py-2 px-2 text-card-foreground whitespace-nowrap">{pedido.modalidade}</td>
                <td className="py-2 px-2 text-card-foreground whitespace-nowrap">{pedido.cidadeOrigem}</td>
                <td className="py-2 px-2 text-card-foreground whitespace-nowrap">{pedido.estado}</td>
              </tr>
            ))}
          </tbody>
        </table>
